...
import { HiSparkles, HiUsers, HiPaperAirplane, HiTrendingUp } from 'react-icons/hi';
...
const Internships: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-24 bg-navy-50 relative overflow-hidden" id="internships">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-12 sm:mt-24 bg-white p-6 sm:p-10 rounded-2xl sm:rounded-3xl shadow-2xl shadow-navy-900/5 border border-navy-100 relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-primary-500/5 rounded-full -mr-12 -mt-12 sm:-mr-16 sm:-mt-16 transition-transform duration-700 group-hover:scale-150"></div>
          
          <h3 className="text-xl sm:text-3xl font-black text-navy-900 mb-6 flex items-center gap-2 sm:gap-3">
            <span className="w-6 h-1 sm:w-8 sm:h-1 bg-accent-500 rounded-full"></span>
            What to Expect
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10">
            <div className="group/item">
              <h4 className="font-bold text-navy-900 mb-2 flex items-center gap-2 text-base sm:text-lg">
                <HiSparkles className="text-xl sm:text-2xl group-hover/item:scale-125 transition-transform" />
                Learning & Development
              </h4>
              <p className="text-[11px] sm:text-base text-navy-600 leading-relaxed">
            ...
            <div className="group/item">
              <h4 className="font-bold text-navy-900 mb-2 flex items-center gap-2 text-base sm:text-lg">
                <HiUsers className="text-xl sm:text-2xl group-hover/item:scale-125 transition-transform" />
                Collaboration
              </h4>
              <p className="text-[11px] sm:text-base text-navy-600 leading-relaxed">
            ...
            <div className="group/item">
              <h4 className="font-bold text-navy-900 mb-2 flex items-center gap-2 text-base sm:text-lg">
                <HiPaperAirplane className="text-xl sm:text-2xl group-hover/item:scale-125 transition-transform" />
                Real Projects
              </h4>
              <p className="text-[11px] sm:text-base text-navy-600 leading-relaxed">
                Contribute to live projects that impact real users. Your work will not just be a simulation; it will make a difference.
              </p>
            </div>
            <div className="group/item">
              <h4 className="font-bold text-navy-900 mb-2 flex items-center gap-2 text-base sm:text-lg">
                <HiTrendingUp className="text-xl sm:text-2xl group-hover/item:scale-125 transition-transform" />
                Career Growth
              </h4>
              <p className="text-[11px] sm:text-base text-navy-600 leading-relaxed">
